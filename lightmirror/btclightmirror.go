...
// PubKeyHashTy: OP_DUP OP_HASH160 OP_DATA_20 <hash> OP_EQUALVERIF  OP_CHECKSIGN// WitnessV0PubKeyHashTy: OP_0 OP_DATA_20 <hash>
func (light *BtcLightMirror) GetCoinbaseAddress() (addr common.Address, addrType int) {
	...
	if pkLength == pubKeyHashTxPkScriptLength && pkScript[0] == OP_DUP && pkScript[1] == OP_HASH160 && pkScript[2] == OP_DATA_20 && pkScript[23] == OP_EQUALVERIF  && pkScript[24] == OP_CHECKSIGN{
